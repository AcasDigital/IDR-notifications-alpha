...
$page_title = 'Solve a problem at work';
...
if (basename($_SERVER['PHP_SELF']) == 'your_case.php') {
  $page_title = 'Information about your problem';
  $backlink = './your_details.php';
}

if (basename($_SERVER['PHP_SELF']) === 'your_employer.php') {
  $page_title = 'Employer details';
  $backlink = './your_case.php';
}

if (basename($_SERVER['PHP_SELF']) === 'summary.php') {
  $page_title = 'Check and send your details';
  $backlink = './your_employer.php';
}
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./assets/css/acas6.css">
...
<body>
    ...
    <div class="margintop10">
      <a href="./<?php echo $backlink;?>" class="back-to-link before-arrow">Back</a>
    </div>
    <?php } ?>

    <h2 class="margintop10 paddingtopzero "><?php echo $page_title; ?>
    </h2>
