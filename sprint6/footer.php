...
/*		$( "#btn-continue" ).on( "click", function() {
		...
		*/
		...
		function scrollToFirstError() {
			console.log ($('.invalid-feedback:visible').length);

			if ($('.invalid-feedback:visible').length > 0) {
				var el = $('.invalid-feedback:visible');
				$('html, body').animate({scrollTop:  el[0].offsetParent.offsetTop+50}, 500);
				$('.invalid-feedback:visible:first').prev().focus();
