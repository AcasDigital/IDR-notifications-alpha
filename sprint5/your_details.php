...
<!--         <p>
 ...
 -->
        <p>
            Provide some basic information so Acas can contact you.
        </p>
...
<!--                 <div class="margintop10">
           ...
           <div class="margintop30 greybg-top-bottom-border">              
            ...
            <div class="margintop30 greybg-top-bottom-border">   
                    <p>
                        If you have asked someone else to speak for you, please provide their name and contact details here:
                    </p>
                ...
                <div class="margintop50">
                    ...
                    <p>
                        Acas will speak to your chosen contact rather than you and it would be helpful to know who they are: 
                    </p>
                    ...
                    <div class="checkbox">
                      <label><input name="rep_relation[]" type="checkbox" <?php echo match_in_arr($_SESSION['acas_proto']['claimant']['representation_relation'], 'Other') == 'Other' ? 'checked' : '';?> value="Other">&nbsp;&nbsp;&nbsp;Other</label>
                    </div>                    
            ...
            <div class="margintop30 greybg-top-bottom-border">              
                ...
                <div id="disability-section" style="display: <?php echo $_SESSION['acas_proto']['claimant']['disability'] == 'Yes' ? 'block' : 'none';?>">
                    <p>
                        <strong>If yes:</strong> If we can’t contact you by phone, please say how we can get in touch. 
                    </p>
