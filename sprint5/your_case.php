...
<?php include 'header.php';?>
    ...
    <div class="c-section-content container paddingtop10" >
        <p>
            <h4>Information about the problem</h4>
        </p>
        ...
        <form class="needs-validation" novalidate name="main-form" method="post" action="your_employer.php">
          ...
          <div class="margintop30 greybg-top-bottom-border">              
            <strong>What is the problem about?</strong>
            <div class="form-group">  
                ...
                <div class="radio">
                  <label><input class='representation' type="checkbox" name="dispute[]" <?php echo match_in_arr($_SESSION['acas_proto']['claimant']['dispute'], "Other, please describe") == "Other, please describe" ? 'checked' : '';?> value="Other, please describe">&nbsp;&nbsp;&nbsp;Other</label>
                </div>                
          ...
          <div class="margintop30 greybg-top-bottom-border">              
            <div class="form-group">
                <label class="acas-form-label" for="Describe">Please provide more information about the problem – a short description will help Acas deal with it quickly (eg, if you’re owed wages, please say how much. If you’ve been unfairly dismissed, please briefly explain the circumstances.)</label>
          ...
          <div class="margintop30  greybg-top-bottom-border">              
            <div class="form-group">  
                <label class="acas-form-label" for="full_name">When did the problem happen? (eg, if you’re owed wages, when should you have been paid? If you’ve been discriminated against, when was the last time it happened?)</label>
