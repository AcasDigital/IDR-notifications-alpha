...
<?php include 'header.php';?>
  ...
  <!--         <p>
   ...
   -->
          <p>
             You should check that the information you have provided is correct before sending it to us.
          </p>

          <p>
             <strong>Please double check that you have provided the correct legal name of your employer.</strong>
          </p>
          ...
          <div>
            <table class="summary_table" width="100%">
                ...
                <tr>
                    ...
                    <td npwrap style="position:relative; min-width: 240px"><div style="position:absolute; top: 0; padding-top: 10px;"><span style="line-height: 2.2;" class="icon-exclaim-before"><strong>Double check legal name</strong></span></div>
          ...
          <div class="margintop50">
              ...
              <div class="before-you-send-container0">
                <h4>Before your send </h4>
                  <p>
                    If you are sure that your information is correct, you may send the form. If any information is incorrect we may not be able to help you and it may also affect the result if your case goes to court.
                  </p>

                <h4>What happens after you send your form?</h4>
                  <p>
                    You will receive a confirmation email shortly, containing a summary of your case and your case reference number (you should quote this whenever you speak to us).
                  </p>

                  <p>
                    We will contact you by phone 2 to 3 days after receiving your form. Make sure that you have any relevant details available for when we contact you (for example, if you've not been paid, be ready to tell us how much you should have been paid and when). This will allow us to help you as quickly as possible.
                  </p>
          ...
          <div class="form-group">
                 <button id="btn-continue" data-next-page="finish.php" type="submit" class="btn btn-acas btn-lime margintopbottom10">Accept and send form</button> 
          </div>
