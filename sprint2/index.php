...
<?php include 'header.php'; ?>
        <!-- <p>
            <a href="#" class="back-to-link before-arrow link-underline">Back</a>
        </p> -->
...
<p>If your dispute is more serious, your organisation should have [<a href="https://www.gov.uk/solve-workplace-dispute/formal-procedures" target="_blank">internal procedures</a>] in place to help resolve the problem more formally.</p> 
...
<ul>
    ...
    <li>fill in a short form to <a class="link-underline" href="./start.php">tell Acas that you intend to take action</a></li>
</ul>
